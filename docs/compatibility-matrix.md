...
| Gemini instructions           | `GEMINI.md`                              | Repo instruction      | Yes               | Planned        | First-wave post-v0.1 target candidate     |
| Copilot repo instructions     | `.github/copilot-instructions.md`        | Repo instruction      | Yes               | Planned        | High-value post-v0.1 target candidate     |
...
Execution order is tracked in [planning/target-expansion.md](../planning/target-expansion.md).
