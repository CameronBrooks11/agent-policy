...
const PLATFORMS = [
  {
    ...
    pkg:     "@cameronbrooks11/agent-policy-linux-x64",
    bin:     "agent-policy",
    archive: "tar.xz",
  },
  {
    ...
    pkg:     "@cameronbrooks11/agent-policy-linux-arm64",
    bin:     "agent-policy",
    archive: "tar.xz",
  },
  {
    ...
    pkg:     "@cameronbrooks11/agent-policy-darwin-x64",
    bin:     "agent-policy",
    archive: "tar.xz",
  },
  {
    ...
    pkg:     "@cameronbrooks11/agent-policy-darwin-arm64",
    bin:     "agent-policy",
    archive: "tar.xz",
  },
  {
    ...
    pkg:     "@cameronbrooks11/agent-policy-win32-x64",
